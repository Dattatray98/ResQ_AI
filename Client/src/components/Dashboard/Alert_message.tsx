...
const Alert_message: React.FC<any> = ({ prediction, onOpenSafety }) => {
  ...
  return (
    <div className={`absolute top-[20%] left-[30%] border border-red-300 shadow-sm rounded-xl h-[40vh] w-[40%] flex  flex-col items-center justify-center bg-red-50 p-10 ${isRisk == true ? "block" : "hidden"}`}>
